...

{
    ...
    border-top: 0px solid #00000024 !important;
...
<div class="mobileview_show">

    <img src="images/mobile_view1.jpg">
	    ...
	    <div class="col-md-4">
	        ...
	        <div class="trail-form" id="trail-form">
                  ...
                  <div class="form">
                     ...
                     <form action="<?php echo Yii::app()->createUrl("main/forms/republicday"); ?>" method="post" role="form" class="contactForm">
                        ...
                        <div class="form-group form-row">
                            <select class="form-control select_course"   name="course" aria-label="Default select example">
                                ...
                                <option value="CCIE Enterprise v1.0">CCIE Enterprise v1.0</option>
                                <option value="CCIE Collaboration v3.0">CCIE Collaboration v3.0</option>
                                <option value="CCIE Security v6.0">CCIE Security v6.0</option>
                                <option value="CCIE Wireless v1.0">CCIE Wireless v1.0</option>
                              </select>
</select>
                        </div>
...
<h3 class="offerhed font-hed"><i>Batch Details</i></h3>
...
<div class="col-md-12">
    ...
    <h4>Benefits of joining Octa Networks-</h4>
...
<source srcset="https://octanetworks.com/images/banner_img_mobile_1.jpg" media="(max-width: 800px)">

<source srcset="https://octanetworks.com/images/banner_img_desktop_1.jpg">

<img class="slide-image" src="https://octanetworks.com/images/banner_img_desktop_1.jpg" alt="">
...
<p class="validity_date">Validity: 30th January 2023.</p>
