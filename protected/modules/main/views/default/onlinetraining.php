         ...
         <div class="col-lg-4 col-md-4 col-sm-12 width_30percent height_237">
                <div class="sidebaar_slider">
                      <div class="owl-carousel owl-theme">
                           <div class="item">
                                <img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/gallery_images/1/IMG_20190806_15202524.jpg" alt="Online Training">
                              </div>
                                      
                         <div class="item">
                            <img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/gallery_images/1/IMG_20190806_15182749.jpg" alt="Online Training">
                          </div>
                        
                          <div class="item">
                            <img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/gallery_images/1/IMG_20190806_1518007.jpg" alt="Online Training">
                          </div>
                          
                           <div class="item">
                            <img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/gallery_images/1/IMG_20190426_17053533.jpg" alt="Online Training">
                          </div>
