        ...
        <div class="col-lg-4 col-md-4 col-sm-12 width_30percent height_237">
                ...
                <div class="sidebaar_slider">
                      <div class="owl-carousel owl-theme">
                               ...
                               <div class="item">
                            <img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/gallery_images/1/IMG_909848.JPG" alt="1 to 1 Training">
                          </div>
                          
                         <div class="item">
                            <img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/gallery_images/1/IMG_91007.JPG" alt="1 to 1 Training">
                          </div>
                        
                         
                          
                           <div class="item">
                            <img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/gallery_images/1/IMG_57896.jpg" alt="1 to 1 Training">
                          </div>
                          
                           <div class="item">
                            <img src="<?php echo Yii::app()->request->getBaseUrl(true); ?>/gallery_images/1/69610455_1668503143280085_260281817070829568_o47.jpg" alt="1 to 1 Training">
                          </div>
