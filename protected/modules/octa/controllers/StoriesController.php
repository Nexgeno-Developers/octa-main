<?php
class StoriesController extends CController
{
	public $heading="Stories Management";
	...
	{
		$id = Yii::app()->request->getParam('id');
		$del = Stories::model()->deleteByPk($id);
		$this->redirect(Yii::app()->createUrl("octa/stories"));
	}
}
