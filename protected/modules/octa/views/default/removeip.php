                ...
                <?php } ?>
                    <section class="panel">
                        <header class="panel-heading">
                            Remove IP
                            <a href="<?php echo Yii::app()->createUrl("octa/default/blockip");?>" class="btn btn-danger pull-right">Block IP</a>
                        </header>
                        <div class="panel-body">
                           <form method="POST" class="form-horizontal" id="" action="<?php echo Yii::app()->createUrl("octa/default/removeip");?>">
