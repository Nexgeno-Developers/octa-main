                ...
                <section class="panel">
                    ...
                    <div class="col-sm-12" style="text-align: center">
                        ...
                        <form id="search-vendor" method="POST" action="<?php echo Yii::app()->createUrl('octa/cert/search');?>">
                           ...
                           <div class="col-lg-2"><a href="<?php echo Yii::app()->createUrl("octa/cert"); ?>" class="btn btn-primary">Back</a></div>     
                        ...
                        <table class="table  table-hover general-table" >
                            ...
                            <tr id="row-<?php echo $certs->id;?>">
                                <td><a href="#"><?php echo $certs->name ?></a></td>
                                ...
                                <td id="date-td-<?=$certs->id;?>">
                                    <?php echo date('d-M-Y', strtotime($certs->date_updated)); ?>   
                                </td>
                                <td>
