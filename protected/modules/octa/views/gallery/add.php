...
<div class="col-lg-12">
    ...
    <section class="panel">
        ...
        <div class="panel-body">
            <form method="POST" id="newgallery" class="form-horizontal" enctype="multipart/form-data"  action="<?php echo Yii::app()->createUrl("octa/event/add"); ?>">
...
<!--                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-6">
                          <input type="text" name="gallery_author" class="form-control" required="required">
                    </div>
                </div>
...
<!--                        <button id="upload-button12" class="btn btn-primary upload" type="submit">Submit</button>-->
  ...
  <button id="upload-button12" data-form="newgallery" data-url="<?= Yii::app()->baseUrl ?>/octa/gallery/addgallery"    data-url2="<?= Yii::app()->baseUrl ?>/octa/gallery"  class="btn btn-primary upload" type="button">Submit</button>
                    </div>
                </div>
