                ...
                <section class="panel">
                    ...
                    <div class="col-sm-12" style="text-align: center">
                        ...
                        <form id="search-vendor" method="POST" action="<?php echo Yii::app()->createUrl('octa/vendor/search');?>">
                          ...
                          <div class="col-lg-2"><a href="<?php echo Yii::app()->createUrl("octa/vendor"); ?>" class="btn btn-primary">Back</a></div>      
                            ...
                            <tr id="row-<?php echo $vendors->id;?>">
                                ...
                                <td id="enable-active-td-<?php echo $vendors->id ?>">
                                 ...
                                 <td id="date-td-<?=$vendors->id;?>">
                                    <?php echo date('d-M-Y', strtotime($vendors->date_updated)); ?>
                                </td>
                                <td>
                   ...
                   <?php 
                    ...
                    <div class="panel-body">
                        ...
                        <a href="<?php echo Yii::app()->createUrl('octa/vendor');?>"> Back </a>
                    </div>
                    <?php
                    }
?>
