    ...
    <div id="success-alert" class="alert alert-success" style="display:none"></div>
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form method="POST" class="form-horizontal " id="" action="<?php echo Yii::app()->createUrl("octa/vendor/edit");?>" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Vendor Name</label>
                                    <div class="col-lg-6">
                                        <input type="text" placeholder="Vendor Name" name="vendor_name" id="vendor_name" class="form-control" value="<?php echo $vendor->name; ?>" required="required">
                                    </div>
                                </div>
								...
								<div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" placeholder="Slug" name="url_slug" id="url_slug" class="form-control" value="<?php echo $vendor->url; ?>" required="required">
                                    </div>
                                </div>
                               ...
                               <div class="form-group">
								...
								<div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" placeholder="Heading" name="ctitle" id="ctitle" class="form-control" required="required" value="<?php echo $vendor->ctitle; ?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-lg-3 control-label">Content</label>
                                    <div class="col-lg-6">
                                        <textarea placeholder="Vendor Description" name="description" id="description" class="form-control ckeditor"  ><?php echo $vendor->description;?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea placeholder="" name="page_title" id="page_title" class="form-control" ><?php echo $vendor->meta_title;?></textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea placeholder="" name="seo_desc" id="seo_desc"  class="form-control" ><?php echo $vendor->meta_desc;?></textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea placeholder="" name="keywords" id="keywords" class="form-control" ><?php echo $vendor->meta_keywords;?></textarea>
                                    </div>
