<div class="col-lg-12">
	...
	<section class="panel">
		<header class="panel-heading">Edit FAQ</header>
		<div class="panel-body">
			<form method="POST" class="form-horizontal " id="" action="<?php Yii::app()->createUrl("octa/faqs/edit");?>">
				...
				<div class="form-group">
					<label class="col-lg-3 control-label">Question Name</label>
					<div class="col-lg-7">
						<div class="compose-editor">
							<input class="form-control" name="question" id="question" value="<?php echo $testi->question; ?>">
						</div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-lg-7">
						<div class="compose-editor">
							<textarea class="form-control ckeditor" name="answer" id="answer" rows="9"><?php echo $testi->answer; ?></textarea>
						</div>
					</div>
				</div>
