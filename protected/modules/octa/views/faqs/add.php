<div class="col-lg-12">
	...
	<section class="panel">
		<header class="panel-heading">Add New FAQ</header>
		<div class="panel-body">
			<form method="POST" class="form-horizontal " id="" action="<?php echo Yii::app()->createUrl("octa/faqs/add");?>" enctype="multipart/form-data">
