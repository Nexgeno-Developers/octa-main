		...
		<div class="panel-body">
			<form method="POST" class="form-horizontal " id="" action="<?php Yii::app()->createUrl("octa/stories/edit");?>" enctype="multipart/form-data">
				...
				<div class="form-group">
					...
					<div class="col-lg-7">
						<select class="form-control selectpicker" id="exam"  name="exam" data-live-search="true" required="required">
							...
							<option value="<?php echo $exams->id; ?>" <?php if($exams->id == $testi->exam_id){ echo 'selected'; } ?>><?php echo $exams->code ?></option>
							<?php } ?>
						</select>
					</div>
				</div>
                ...
                <div class="form-group">
					...
					<div class="col-lg-7">
						<div class="compose-editor">
							<input type="date" class="form-control" name="date" id="date" value="<?php echo date('Y-m-d', strtotime($testi->created_date)); ?>" required>
						</div>
					</div>
				</div>				
