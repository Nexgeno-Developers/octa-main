...
<?php 
    ...
    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form method="POST" class="form-horizontal " enctype="multipart/form-data" action="<?php Yii::app()->createUrl("octa/gallery/edit");?>">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <?php 
											...
											if(!empty($postimage)){
												...
												$dir_path = Yii::app()->basePath.'/../img/gallery/'.$postimage;

												if(file_exists($dir_path)){

													echo "<img src='".Yii::app()->request->getBaseUrl(true)."/img/gallery/".$postimage."' width='400' />";
