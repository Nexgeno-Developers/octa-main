...
<!--                        <button id="upload-button12" class="btn btn-primary upload" type="submit">Submit</button>-->
  ...
  <button id="upload-button12" data-form="galleryImages"  data-url2="<?= Yii::app()->createUrl("admin/gallery/viewimages", array("id"=>Yii::app()->request->getParam("id"))) ?>"   data-url="<?= Yii::app()->baseUrl ?>/admin/gallery/addgalleryimages" class="btn btn-primary upload" type="button">Submit</button>
                    </div>
                </div>
