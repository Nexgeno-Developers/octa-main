...
if(Yii::app()->request->getParam("delete") != null && Yii::app()->request->getParam("delete") == "alltop"){

$cri = new CDbCriteria();
Exam::model()->updateAll(array("is_top"=>0),$cri);	
$msg = "Remove All Top Exams Successfully";
                ...
                <section class="panel">
                    ...
                    <div class="col-sm-12" style="text-align:center" >
                        <div style="padding:10px;">
                            <h3 class="text-success">Top Exams Maximum Limit <?=$totalLimit?></h3>
...
<?php }else{ ?>
                        ...
                        <form id="search-vendor" method="POST" action="<?php echo Yii::app()->createUrl('octa/exam/addtop');?>">
                             <div class="form-group">
                            <label class="col-lg-2 control-label">Exam Code</label>
                            <div class="col-lg-3">
                                <select class="selectpicker" data-live-search="true" name="topcode">
...
<?php } ?>
                            ...
                            <div class="col-lg-2">
                              <input type="submit" class="btn btn-primary"  value="Add Top Exam"/>  
                            </div>
                             </div> 
...
<div class="col-lg-2">
							...
							<div class="col-lg-2">
                              		...
                              		<a href="<?php echo Yii::app()->createUrl("octa/exam/topexams",array("delete"=>"alltop"));?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete all top exams?')">Delete All Top Exams</a>
...
echo  Yii::app()->dateFormatter->format('dd-MMM-y',$exams->date_updated);
 ...
 ?>
                                ...
                                <td>
                                    <a href="<?php echo Yii::app()->createUrl("octa/exam/topdelete",array("id"=>$exams->id));?>" onclick="return confirm('Are you sure you want to delete this exam?')"><img src="<?php echo Yii::app()->baseUrl?>/images/delete-icon.png" alt=""/></a>
                                </td>
