    ...
    <div id="danger-alert" class="alert alert-danger" style="display:none"></div>
                <section class="panel">
                    <header class="panel-heading" style="text-align: center">
                       <a href="<?php echo Yii::app()->createUrl('octa/exam/exportexams');?>" class='btn btn-primary'> Export All Exams </a>
                    ...
                    <div class="col-sm-12" style="text-align:center" >
                        ...
                        <form id="search-vendor" method="POST" action="<?php echo Yii::app()->createUrl('octa/exam/search');?>">
                            ...
                            <div class="col-lg-1"><a  href="<?php echo Yii::app()->createUrl("octa/exam/addexam");?>"  class="btn btn-success" >Add New</a></div>
                            <div class="col-lg-1"><a  href="<?php echo Yii::app()->createUrl("octa/exam/enableall");?>"  class="btn btn-primary" >Enable All</a></div>
                            <div class="col-lg-1"><a  href="<?php echo Yii::app()->createUrl("octa/exam/disableall");?>" class="btn btn-danger" >Disable All</a></div>

						<form action="<?php Yii::app()->CreateURL("octa/exam/download_listing"); ?>" method="get" name="filterpage">
								<div class="col-lg-1">
                    ...
                    <div class="panel-body">
                        <table class="table  table-hover general-table" >
                            ...
                            <tr id="row-<?php echo $exams->id;?>">
                               ...
                               <td><a href="<?php echo Yii::app()->createUrl("octa/topics/index",array("id"=>$exams->id));?>">Topics (<?=count($exams->topics)?>)</a></td>
                               <td><a href="<?php echo Yii::app()->createUrl("octa/faqs/index",array("id"=>$exams->id));?>">FAQs (<?=count($exams->faqs)?>)</a></td>
                               <td><a href="<?php echo Yii::app()->createUrl("octa/demos/index",array("id"=>$exams->id));?>">Demo (<?=count($exams->demos)?>)</a></td>
