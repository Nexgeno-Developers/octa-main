<div class="col-lg-12">
	...
	<section class="panel">
		<header class="panel-heading">Add New Scroll Stories</header>
		<div class="panel-body">
			<form method="POST" class="form-horizontal " id="" action="<?php echo Yii::app()->createUrl("octa/scrollstories/add");?>" enctype="multipart/form-data">
