...
/**
 * This is the model class for table "stories_recent".
 *
 * The followings are the available columns in table 'stories_recent':
 * @property integer $id
 ...
 */
class StoriesRecent extends CActiveRecord
{
	/**
	 ...
	 * @return stories_recent the static model class
	 */
