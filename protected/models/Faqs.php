...
class Faqs extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('exam_id, status', 'numerical', 'integerOnly'=>true),
			array('question', 'length', 'max'=>350),
			array('answer, date_added', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, exam_id, question, answer, status, date_added', 'safe', 'on'=>'search'),
		);
	}
