...
/**
 * This is the model class for table "Stories1".
 *
 * The followings are the available columns in table 'Stories1':
 * @property integer $id
 ...
 */
class Stories1 extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, exam_id, name, expert, content, image, created_date, updated_date, series', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Stories1 the static model class
	 */
